...
if __name__ == '__main__':
    ...
    best_loss = [float('inf')] * num_models  # Initialize best validation loss for each model
    ...
    for i, model in enumerate(models_list):
        ...
        for i, model in enumerate(models_list):
            ...
            # Create lists to store loss per epoch
            train_losses = []
            val_losses = []
            ...
            for epoch in range(num_epochs):
                ...
                # Save the model weights if validation loss decreases
